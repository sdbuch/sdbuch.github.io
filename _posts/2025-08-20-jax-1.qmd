...
- Types are relatively self-explanatory, aside from the text in braces---the
  ...
  layout of the array. Axis indices are listed in minor-to-major order (i.e.,
  `1, 0` denotes row-major layout).
...
We also recapitulated information from the TPU Scaling book about how to
